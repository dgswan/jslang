...
{
      15,     0,    -1,    16,    -1,    16,     6,    16,    -1,    16,
      10,    16,    -1,    16,     9,    16,    -1,    16,     5,    16,
      -1,    11,    16,    12,    -1,    13,    -1
};
...
{
  "$end", "error", "$undefined", "'+'", "'-'", "TOKEN_MINUS",
  "TOKEN_PLUS", "'*'", "'/'", "TOKEN_DIVIDE", "TOKEN_MULTIPLY",
...
{
       5,     1,     6,     2,     9,    10,    12,    13,    14,    15,
       7,     8,     0,     0,     9,    10,     0,    11,     7,     8,
       0,     0,     9,    10
};
...
{
       1,    11,     0,    13,     9,    10,     7,     8,     9,    10,
       5,     6,    -1,    -1,     9,    10,    -1,    12,     5,     6,
      -1,    -1,     9,    10
};
